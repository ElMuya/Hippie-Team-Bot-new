...
if(args[0])
 ...
 const { channel } = message.member.voice;
    ...
    .setLabel(`Pause`)
    .setEmoji(`972510894674301009`)
    .setID(`pause`)
    .setStyle("grey");

    let button2 = new MessageButton()
    .setLabel(`Resume`)
    .setEmoji(`972510894707851275`)
    .setID(`resume`)
    .setStyle("grey");

    let button3 = new MessageButton()
    .setLabel(`Skip`)
    .setEmoji(`972510895148261386`)
    .setID(`skip`)
    .setStyle("grey");
